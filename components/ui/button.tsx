...
const btnColor: {
    ...
    Default: "  rounded outline-none text-white 3xl:w-fit 3xl:px-4  3xl:h-16 3xl:text-2xl hover:opacity-80  cursor-pointer flex gap-2 justify-center items-center  ",
